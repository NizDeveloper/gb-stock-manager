...
class InventoryPage extends StatefulWidget {
  ...
  const InventoryPage({super.key, this.onRegisterOpen, this.initialCategory});
...
class _InventoryPageState extends State<InventoryPage> {
  ...
  String _selectedCategory = 'Todos'; // se sobreescribe en initState
  String _searchQuery = '';
  ...
  Widget _buildProductCard(Product p) {
    ...
    final stockRatio = p.minStock > 0
        ? (p.stock / (p.minStock * 6)).clamp(0.0, 1.0)
        : 1.0;
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      children: [
                        ...
                        _infoTile(
                          '⚠️ Stock mínimo',
                          _product.minStock.toString(),
                          Colors.white,
                        ),
                        _infoTile(
                          '🟠 Precio compra',
                          '\$${_product.buyPrice.toStringAsFixed(0)}',
                          Colors.white,
                        ),
                        _infoTile(
                          '🏷️ Precio venta',
                          '\$${_product.sellPrice.toStringAsFixed(0)}',
                          Colors.white,
                        ),
...
class _AdjustStockSheetState extends State<_AdjustStockSheet> {
  ...
  void _apply() {
    ...
    final mov = _StockMovement(
      type: _reasonCtrl.text.trim().isEmpty
          ? _movType
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        '${widget.product.name} (Stock: ${widget.product.stock})',
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 13,
                        ),
